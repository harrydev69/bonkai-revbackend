...
export default function Dashboard() {
  ...
  useEffect(() => {
    const id = setInterval(() => {
      setBonkData((prev) => ({
        ...
        socialVolume: Math.floor(
          prev.socialVolume + (Math.random() - 0.5) * 100
        ),
      }));
    }, 5000);
  ...
  useEffect(() => {
    const unsubscribe = dataService.subscribeToRealTimeData(
      (newData: BonkData) => {
        setBonkData(newData);
      }
    );
  ...
  const derivedRefreshMs = settings.api.autoRefresh
    ? settings.api.refreshInterval * 1000
    : 1_000_000_000; // ~11.5 days
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400">
            Customize your BONKai experience
          </p>
        </div>
      </div>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                handleSettingsChange("notifications", "priceAlerts", v)
              }
            />
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Get notified about unusual volume activity
              </p>
            </div>
            <Switch
              checked={settings.notifications.volumeAlerts}
              onCheckedChange={(v) =>
                handleSettingsChange("notifications", "volumeAlerts", v)
              }
            />
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Get notified about social media trends
              </p>
            </div>
            <Switch
              checked={settings.notifications.socialAlerts}
              onCheckedChange={(v) =>
                handleSettingsChange("notifications", "socialAlerts", v)
              }
            />
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                handleSettingsChange("notifications", "newsAlerts", v)
              }
            />
          </div>
        </CardContent>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <Select
              ...
              onValueChange={(v) =>
                handleSettingsChange("display", "currency", v)
              }
            >
              <SelectTrigger className="w-32">
                <SelectValue />
          ...
          <div className="flex items-center justify-between">
            ...
            <Select
              ...
              onValueChange={(v) =>
                handleSettingsChange("display", "language", v)
              }
            >
              <SelectTrigger className="w-32">
                <SelectValue />
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Help improve BONKai with usage analytics
              </p>
            </div>
            <Switch
              checked={settings.privacy.analytics}
              onCheckedChange={(v) =>
                handleSettingsChange("privacy", "analytics", v)
              }
            />
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                handleSettingsChange("privacy", "cookies", v)
              }
            />
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                handleSettingsChange("privacy", "dataSharing", v)
              }
            />
          </div>
        </CardContent>
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Configure data refresh and API settings
              </CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                handleSettingsChange("api", "autoRefresh", v)
              }
            />
          </div>
          <Separator />
          <div className="flex items-center justify-between">
            ...
            <Select
              ...
              onValueChange={(v) =>
                handleSettingsChange("api", "refreshInterval", parseInt(v))
              }
            >
              <SelectTrigger className="w-32">
                <SelectValue />
          ...
          <div className="flex items-center justify-between">
            ...
            <Switch
              ...
              onCheckedChange={(v) =>
                handleSettingsChange("api", "enableWebSocket", v)
              }
            />
          </div>
        </CardContent>
